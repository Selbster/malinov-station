...
public sealed partial class PuddleSystem : SharedPuddleSystem
{
        ...
        bool tileReact = true)
    {
        ...
        var anchored = _map.GetAnchoredEntities(gridId, mapGrid, tileRef.GridIndices); // Malinov edit - equivalent current map API.
    ...
    public bool TryGetPuddle(TileRef tile, out EntityUid puddleUid)
    {
        ...
        var anc = _map.GetAnchoredEntities(tile.GridUid, grid, tile.GridIndices); // Malinov edit - equivalent current map API.
