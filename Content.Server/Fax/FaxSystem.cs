...
public sealed partial class FaxSystem : EntitySystem
{
    ...
    private void NotifyAdmins(string faxName)
    {
        ...
        _audioSystem.PlayGlobal(new ResolvedPathSpecifier("/Audio/Machines/high_tech_confirm.ogg"), Filter.Empty().AddPlayers(_adminManager.ActiveAdmins), false, AudioParams.Default.AddVolume(-8f)); // Malinov edit - explicit sound path.
    }
}
