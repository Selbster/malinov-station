...
surgery-step-incision-desc = Разрезать кожу скальпелем.
surgery-step-incision-popup = { CAPITALIZE($user) } делает надрез.
...
surgery-step-clamp-bleeders-name = Зажать сосуды
surgery-step-clamp-bleeders-desc = Зажать кровоточащие сосуды гемостатом.

surgery-step-extract-organ-name = Извлечь орган
surgery-step-extract-organ-desc = Аккуратно извлечь орган.
surgery-step-extract-organ-popup = { CAPITALIZE($user) } извлекает орган у { OBJECT($target) }.

surgery-step-insert-organ-name = Установить орган
surgery-step-insert-organ-desc = Аккуратно поместить орган в полость.
surgery-step-insert-organ-popup = { CAPITALIZE($user) } помещает орган в тело { OBJECT($target) }.
...
surgery-heart-extraction-name = Сердце — Извлечение
surgery-heart-extraction-desc = Извлекает сердце пациента через грудную клетку.
surgery-heart-installation-name = Сердце — Установка
surgery-heart-installation-desc = Устанавливает сердце в грудную клетку пациента.

# Лёгкие

surgery-lungs-extraction-name = Лёгкие — Извлечение
surgery-lungs-extraction-desc = Извлекает лёгкие пациента через грудную клетку.
surgery-lungs-installation-name = Лёгкие — Установка
surgery-lungs-installation-desc = Устанавливает лёгкие в грудную клетку пациента.

# Желудок

surgery-stomach-extraction-name = Желудок — Извлечение
surgery-stomach-extraction-desc = Извлекает желудок пациента через разрез на животе.
surgery-stomach-installation-name = Желудок — Установка
surgery-stomach-installation-desc = Устанавливает желудок в брюшную полость пациента.

# Печень

surgery-liver-extraction-name = Печень — Извлечение
surgery-liver-extraction-desc = Извлекает печень пациента через разрез на животе.
surgery-liver-installation-name = Печень — Установка
surgery-liver-installation-desc = Устанавливает печень в брюшную полость пациента.

# Почки

surgery-kidneys-extraction-name = Почки — Извлечение
surgery-kidneys-extraction-desc = Извлекает почки пациента через разрез на животе.
surgery-kidneys-installation-name = Почки — Установка
surgery-kidneys-installation-desc = Устанавливает почки в брюшную полость пациента.

# Аппендикс

surgery-appendix-extraction-name = Аппендикс — Извлечение
surgery-appendix-extraction-desc = Извлекает аппендикс пациента через разрез на животе.
surgery-appendix-installation-name = Аппендикс — Установка
surgery-appendix-installation-desc = Устанавливает аппендикс в брюшную полость пациента.

# Глаза

surgery-eyes-extraction-name = Глаза — Извлечение
surgery-eyes-extraction-desc = Извлекает глаза пациента.
surgery-eyes-installation-name = Глаза — Установка
surgery-eyes-installation-desc = Устанавливает пару глаз в глазницы пациента.

# Уши

surgery-ears-extraction-name = Уши — Извлечение
surgery-ears-extraction-desc = Извлекает уши пациента.
surgery-ears-installation-name = Уши — Установка
surgery-ears-installation-desc = Устанавливает пару ушей на голову пациента.

# Язык

surgery-tongue-extraction-name = Язык — Извлечение
