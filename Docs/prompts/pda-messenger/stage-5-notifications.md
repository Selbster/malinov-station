...
Один этап = один атомарный коммит: `feat(pda-messenger): этап 5 — уведомления о входящих`.
...
Этапы 0–4b: скелет; каталог; прямая доставка; история; сервер-релей с ack/failover.
