...
- type: entity
  id: mob-hostile-carp   # hyphens

- type: entity
  id: MOBHOSTILECARP     # all uppercase
...
- type: entity
  id: MobHostileCarp
  parent:
  - BaseMob                # Inherits from multiple parents
  - MobCombat
  - MobBloodstream
...
1. **Names with lowercase letters**: `ent-MobCarpChitter = chitter`
2. **Descriptions with a capital letter**: `.desc = A hostile space carp that attacks anything in range.`
