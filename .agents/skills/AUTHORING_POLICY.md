...
For every skill in `.agents/skills/<skill-name>`, keep a matching bridge file:
...
A PR is incomplete if any skill exists in `.agents/skills` without a matching bridge in
`.claude/skills`.
