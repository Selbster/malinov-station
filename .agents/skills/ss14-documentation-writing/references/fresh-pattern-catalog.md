...
| Large subsystem docs | Dividing a large system into partial parts with a separate area of ​​responsibility | `Shared*System` partial-file families | 2026-01-24 | Use |
| Cross-system docs | Check for unusual API calls in system consumers | non-default optional flags, e.g. `TryDoSomething(..., force: true, quiet: true)` | 2026-01-08 / 2025-11-29 | Use |
