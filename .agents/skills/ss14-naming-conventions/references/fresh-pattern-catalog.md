...
| Prototype IDs | `CamelCase` for ID | `FloorWaterEntity`, `MobCarpChitter` | 2026-01-08 | Use |
| Fork IDs | `Malinov` prefix for `_MalinovStation`-only content | `MalinovAmmunition` | 2026-01-14 | Use |
