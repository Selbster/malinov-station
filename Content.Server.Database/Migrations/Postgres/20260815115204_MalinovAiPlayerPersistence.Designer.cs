...
namespace Content.Server.Database.Migrations.Postgres
{
    ...
    [Migration("20260815115204_MalinovAiPlayerPersistence")]
    partial class MalinovAiPlayerPersistence
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Content.Server.Database.AiPlayerMemoryRecord", b =>
                {
                    b.HasOne("Content.Server.Database.AiPlayerPersonality", "Personality")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_ai_player_memory_record_ai_player_personality_personality_t~");
