...
public sealed partial class SharedKitchenSpikeSystem : EntitySystem
{
    ...
    private void OnInteractUsing(Entity<KitchenSpikeComponent> ent, ref InteractUsingEvent args)
    {
        ...
        {
            _popupSystem.PopupEntity(Loc.GetString("comp-kitchen-spike-butcher-empty", ("victim", Identity.Entity(victim.Value, EntityManager))), ent, args.User, PopupType.MediumCaution); // Malinov-Edit
            return;
        }
