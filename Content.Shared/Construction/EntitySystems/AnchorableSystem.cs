...
public sealed partial class AnchorableSystem : EntitySystem
{
    ...
    {
        var enumerator = _map.GetAnchoredEntities(grid, grid.Comp, gridIndices); // Malinov-Edit
    ...
    public bool AnyUnstackablesAnchoredAt(EntityCoordinates location)
    {
        ...
        var enumerator = _map.GetAnchoredEntities(gridUid.Value, grid, _map.LocalToTile(gridUid.Value, grid, location)); // Malinov-Edit
